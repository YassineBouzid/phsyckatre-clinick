...
if __name__ == '__main__':
    ...
    hashed_password = bcrypt.hashpw("xxxxxxxxxxxxxxxxxxx".encode('utf-8'), bcrypt.gensalt()).decode('utf-8')
    admin = User(id=1,username= "xxxxxxxxxxxxxxxxxxx", password_hash=hashed_password)
